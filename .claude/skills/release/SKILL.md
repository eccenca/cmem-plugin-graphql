...
Then watch the publish workflow at https://github.com/eccenca/cmem-plugin-graphql/actions and confirm the
new version appeared on [PyPI](https://pypi.org/project/cmem-plugin-graphql/).
